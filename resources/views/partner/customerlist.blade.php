    ...
    <div class="card-body overflow-hidden">
      <div class="card-header p-0 border-0">
        ...
        <nav class="nav nav-icon nav-icon-sm ms-auto">
          ...
          <button type="button" class="btn add_customer_btn" style="background-color: #8c46cd; color:white;">Add Customers</button>
        </nav>
      </div>
                ...
                <table class="table table-one">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                      <a class="" href="{{url('customers').'/'.$customer->id.'/catalog'}}" >Edit catalog</a>
                        <!-- <div class="dropdown">
                          ...
                          <ul class="dropdown-menu shadow" aria-labelledby="dropdownMenuButton1">
                            <li>
                              <a class="dropdown-item" href="{{url('customers').'/'.$customer->id.'/catalog'}}" class="application-manage">Edit catalog</a>
                            </li>
                          </ul>
                        </div> -->
                      </td>
